<template >
    ...
    <div class="content">
      <div class="input-info">
        ...
        <input type="text" @input="getCarnumValue" value="{{carNum}}" placeholder="请填写车号">
      </div>
      <div class="input-info">
        <div class="input-info-title">危险化学品名称</div>
        <input type="text" @input="getNameValue" value="{{name}}" placeholder="请填写危险化学品名称">
      </div>
      <div class="input-info">
      ...
      <div class="input-info">
        ...
        <input type="text" @input="getTransUnitValue" value="{{transUnit}}" placeholder="请填写运输单位">
      </div>
      <div class="input-info">
        <div class="input-info-title">运/提货单号</div>
        <input type="text" @input="getCargoNumValue" value="{{cargoNumber}}" placeholder="请填写运/提货单号">
      </div>
    </div>
    <!-- 运输区间 -->
    ...
    <div class="content">
      ...
      <div class="input-info">
        ...
        <input type="text" @input="getPassValue" value="{{pass}}" placeholder="请填写途径地">
      </div>
    </div>
    <!-- 公安检查 -->
...
<script>
    ...
    onShow() {
      ...
      // 进站检查时间
      getInTimeValue: function(e) {
        this.inTime = e.target.value;
      },
      // 离站时间
      getOutTimeValue: function(e) {
